...
function populateFigures() {
	...
	if (figureCount === 3) {	
	for (var i = 1; i < 4; i++) {
	filename = "pics/beer0" + photoOrder[i] + "sm.jpg";
...
/* \
, and change values in photoOrder array to match  */
...
function previewFive() {
	...
	firstFigure.id = "beer1";
	firstFigure.style.right = "";
	firstFigure.style.left = "45px";
	//articleE1.appendChild(firstFigure);
		articleE1.insertBefore(firstFigure, document.getElementById("beer2"));
		figureCount = 5;

	// add appropriate src values to two new img elements
document.getElementsByTagName("img") [0].src = "pics/beer0" + photoOrder[0] + "sm.jpg";
document.getElementsByTagName("img") [4].src = "pics/beer0" + photoOrder[4] + "sm.jpg";
...
function previewThree() {
	...
	var numberButton = document.querySelector("#fiveButton p");
		...
		articleE1.removeChild(document.getElementById("beer1"));
		articleE1.removeChild(document.getElementById("beer5"));
